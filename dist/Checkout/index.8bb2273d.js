...
const garmentSelectedList = document.querySelector(".garment-selected-container");
let garmentSelected_deserialized = JSON.parse(localStorage.getItem("garmentSelectedGroup"));
...
const garmentSelectedSubTotal = shirtTotal + shortTotal + trouserTotal + bedsheetTotal + hoodieTotal + underwearTotal;
...
setInterval(()=>{
    ...
    if (deliveryCostButton.checked) {
        ...
        const garmentSelectedGrandTotal = garmentSelectedSubTotal + parseFloat(deliveryCostButton.value);
...
if (garmentSelected_deserialized.short > 0) {
    let shortTotal1 = garmentSelected_deserialized.short * 20;
    const shortItem = `
          <article class="garment-selected-section">
            <div class="garment-img-wrapper">
...
//# sourceMappingURL=index.8bb2273d.js.map
